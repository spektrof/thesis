...
template <typename V>
Utility::PlaneResult PlaneGetterFunctions<V>::PlanarFittingOn3dPoints(std::set<approx::Vector3<float>, approx::DifferentVector3<float>> tmp)	/*set mert legyen minden pont kül.*/
{
